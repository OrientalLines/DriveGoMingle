    ...
    <div class="w-full space-y-8">
        ...
        <div class="space-y-4">
            <button
                ...
                class="flex w-full items-center justify-center space-x-3 rounded-xl bg-primary py-4 font-medium text-white"
                >
                <span class="material-icons">email</span>
                <span>Продолжить по email</span>
            </button>
            <button
                class="flex w-full items-center justify-center space-x-3 rounded-xl border border-background-secondary py-4 font-medium text-white"
                >
